...
- [NvimTheme](https://rmkohlman.github.io/MaestroNvim/reference/nvim-theme/) - Neovim themes that can be referenced
- [Workspace](https://rmkohlman.github.io/devopsmaestro/reference/workspace/) - Workspaces can specify WezTerm configs
